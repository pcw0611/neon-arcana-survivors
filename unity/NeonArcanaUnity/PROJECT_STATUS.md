...
- 보스 출현 중앙 경고와 미니맵 노란 보스 표식
- 강화 태그 친화도·3장 선택·슬롯 천장·마스터 선행 조건
- 강화·유물·전직 숫자키 1~5 선택
- 화면 빈 영역 64px 터치 드래그 이동과 단일 패드 입력 통합
- 시간·출처·티어·태그 기반 18틱 유물 룰렛과 자동 보상
- 위성 명중 방전·일반 적탄 요격·주기 충격파
...
- HUD 보스 경고·미니맵 보스 표식 — 구현·기술 검증 통과, 사용자 승인 대기
- 미니맵 보물·리바이어던·내부 던전 등 특수 표적
- 강화 선택 규칙 — 구현·기술 검증 통과, 사용자 승인 대기
- 위성 방전·요격·충격파와 마스터 특수기 실제 효과
- 전체 화면 터치 드래그 — 구현·기술 검증 통과, Android 실기기 승인 대기
- 유물 룰렛·자동 레벨업/장착/교체·결과 확인 — 구현·기술 검증 통과, 사용자 승인 대기
- 위성 강화 3종 실제 효과 — 구현·기술 검증 통과, 사용자 승인 대기
