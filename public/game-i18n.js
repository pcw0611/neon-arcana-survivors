(function (global) {
  ...
  const messages = {
    ...
    zh: {
      ...
      'hud.codex': '图鉴', 'hud.relics': '遗物装备', 'hud.bossLimit': '限制 {time}', 'hud.hp': '生命 {current}/{max}', 'hud.level': 'LV.{level}', 'hud.kills': '✦ {count}',
    ...
    ja: {
      ...
      'hud.codex': '図鑑', 'hud.relics': '遺物装備', 'hud.bossLimit': '制限 {time}', 'hud.hp': 'HP {current}/{max}', 'hud.level': 'LV.{level}', 'hud.kills': '✦ {count}',
    ...
    en: {
      ...
      'hud.codex': 'CODEX', 'hud.relics': 'RELIC LOADOUT', 'hud.bossLimit': 'LIMIT {time}', 'hud.hp': 'HP {current}/{max}', 'hud.level': 'LV.{level}', 'hud.kills': '✦ {count}',
