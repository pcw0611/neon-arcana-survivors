(function (global) {
  ...
  const messages = {
    ...
    zh: {
      ...
      'menu.open': '菜单', 'menu.title': '作战菜单', 'menu.resume': '继续游戏', 'menu.quit': '放弃作战', 'menu.quitConfirmTitle': '要放弃本次作战吗？', 'menu.quitConfirmBody': '将以当前记录结束作战，并把分数上传至排行榜。', 'menu.quitConfirm': '放弃并查看结果', 'menu.sound': '声音', 'menu.music': '背景音乐', 'menu.effects': '音效', 'menu.language': '语言', 'menu.settings': '设置',
    ...
    ja: {
      ...
      'menu.open': 'メニュー', 'menu.title': '作戦メニュー', 'menu.resume': 'ゲームに戻る', 'menu.quit': '作戦を放棄', 'menu.quitConfirmTitle': '作戦を放棄しますか？', 'menu.quitConfirmBody': '現在の記録で作戦を終了し、スコアをランキングに登録します。', 'menu.quitConfirm': '放棄して結果を見る', 'menu.sound': 'サウンド', 'menu.music': 'BGM', 'menu.effects': '効果音', 'menu.language': '言語', 'menu.settings': '設定',
      ...
      'technique.projectile': '星座弾術式', 'technique.saber': 'アストラル光剣術式', 'technique.orbit': '守護衛星体術式', 'technique.orbitDefense': '軌道迎撃術式', 'technique.orbitDefenseDesc': '衛星体に触れた敵ミサイルを {chance}% の確率で消去します。', 'technique.pulse': '脈動星環', 'technique.pulseDesc': '全衛星体が周期的に衝撃波を放ちます。現在の間隔：{seconds}秒', 'technique.masterProjectile': '画面を貫く高威力レーザーを発射します。', 'technique.masterSaber': '周期的に全方向を薙ぐ黄金旋回斬りを発動します。', 'technique.masterOrbit': '衛星体が敵を追跡して爆発し、その後帰還します。',
    ...
    en: {
      ...
      'menu.open': 'Menu', 'menu.title': 'Operation Menu', 'menu.resume': 'Resume', 'menu.quit': 'Abandon Operation', 'menu.quitConfirmTitle': 'Abandon this operation?', 'menu.quitConfirmBody': 'The operation will end with your current record, and the score will be submitted to the leaderboard.', 'menu.quitConfirm': 'Abandon and View Results', 'menu.sound': 'Sound', 'menu.music': 'Music', 'menu.effects': 'Sound Effects', 'menu.language': 'Language', 'menu.settings': 'Settings',
      ...
      'technique.projectile': 'Constellation Shot Technique', 'technique.saber': 'Astral Saber Technique', 'technique.orbit': 'Guardian Orbital Technique', 'technique.orbitDefense': 'Orbital Interception Technique', 'technique.orbitDefenseDesc': 'Enemy missiles touching an orbital are destroyed with a {chance}% chance.', 'technique.pulse': 'Pulsing Star Ring', 'technique.pulseDesc': 'All orbitals periodically emit a shockwave. Current interval: {seconds}s', 'technique.masterProjectile': 'Fires a high-powered piercing laser across the screen.', 'technique.masterSaber': 'Periodically unleashes a golden whirlwind slash in every direction.', 'technique.masterOrbit': 'Orbitals chase enemies, explode, and then return.',
      ...
      'codex.title': 'NEON ARCANA CODEX', 'codex.techniques': 'Techniques', 'codex.relics': 'Relics', 'codex.locked': 'Undiscovered', 'codex.masterEffect': 'Completion Special Effect', 'codex.limitBreak': 'Limit Break available after completion',
  ...
  const catalogs = {
    ko: {
      upgrade: {
        ...
        blast: ['붕괴 잔향', '명중 폭발 범위 +22'],
        chain: ['연쇄 낙뢰', '주변 적에게 낙뢰 +1회'],
        ...
        orbit_shock: ['초신성 방전', '위성체 명중 시 12% 확률로 범위 방전'],
        ...
        limit_master_projectile: ['성좌포 한계돌파', '완성 레이저 피해 +4%p, 범위 +2%p (범위 LV.20 상한)'],
        limit_master_saber: ['광검 한계돌파', '완성 선회참 피해 +4%p, 범위 +2%p (범위 LV.20 상한)'],
        limit_master_orbit: ['위성체 한계돌파', '완성 추격 폭발 피해 +4%p, 범위 +2%p (범위 LV.20 상한)'],
      ...
      relic: {
        ...
        midas: ['미다스 바이러스', '잭팟 그렘린 출현 간격 -45%, 유물 등급 보정'],
      },
      mastery: {
    ...
    en: {
      upgrade: {
        power: ['Rune Amplification', 'All attack damage +12%'], haste: ['Cast Acceleration', 'Constellation Shot interval -13%'], multishot: ['Binary Orbit', 'Simultaneous Constellation Shots +1'], pierce: ['Phase Pierce', 'Projectile pierces +1'], critical: ['Fate Interference', 'Critical chance +8%, critical multiplier +0.18'], blast: ['Collapse Echo', 'Impact blast radius +22'], chain: ['Chain Lightning', 'Lightning arcs to +1 nearby enemy'], size: ['Giant Star Core', 'Projectile size +18%, damage +10%'],
        orbit: ['Guardian Orbital', 'Attack orbital +1; unlocks the orbital build'], orbit_speed: ['Hyper Orbit', 'Orbital rotation speed +24%'], orbit_size: ['Giant Orbital Core', 'Orbital size +20%, damage +16%'], orbit_range: ['Dual Orbital Plane', 'Orbit radius +16, orbital damage +10%'], orbit_shock: ['Supernova Discharge', '12% chance for an area discharge on orbital hit'], orbit_pulse: ['Pulsing Star Ring', 'All orbitals periodically emit a shockwave'], orbit_guard: ['Orbital Interception', 'Orbitals have a chance to destroy enemy missiles they touch'], orbit_intercept: ['Orbital Interception', 'Orbitals have a chance to destroy enemy missiles they touch'],
    ...
    zh: {
      upgrade: {
        power: ['符文增幅', '所有攻击伤害 +12%'], haste: ['咏唱加速', '星座弹攻击间隔缩短 13%'], multishot: ['双星轨道', '同时发射的星座弹 +1'], pierce: ['相位贯穿', '星座弹贯穿次数 +1'], critical: ['命运干涉', '暴击率 +8%，暴击倍率 +0.18'], blast: ['崩坏余响', '命中爆炸范围 +22'], chain: ['连锁雷击', '对附近敌人额外落雷 +1次'], size: ['巨型星核', '星座弹尺寸 +18%，伤害 +10%'],
        orbit: ['守护卫星体', '攻击卫星体 +1，解锁卫星体构筑'], orbit_speed: ['超高速公转', '卫星体旋转速度 +24%'], orbit_size: ['巨型卫星核', '卫星体尺寸 +20%，伤害 +16%'], orbit_range: ['双重公转面', '公转半径 +16，卫星体伤害 +10%'], orbit_shock: ['超新星放电', '卫星体命中时有 12% 概率范围放电'], orbit_pulse: ['脉动星环', '所有卫星体周期性释放冲击波'], orbit_guard: ['轨道拦截', '卫星体接触敌方导弹时有一定概率将其消除'], orbit_intercept: ['轨道拦截', '卫星体接触敌方导弹时有一定概率将其消除'],
    ...
    ja: {
      upgrade: {
        power: ['ルーン増幅', '全攻撃ダメージ +12%'], haste: ['詠唱加速', '星座弾の攻撃間隔 -13%'], multishot: ['双星軌道', '同時発射する星座弾 +1'], pierce: ['位相貫通', '星座弾の貫通回数 +1'], critical: ['運命干渉', 'クリティカル率 +8%、倍率 +0.18'], blast: ['崩壊残響', '命中時の爆発範囲 +22'], chain: ['連鎖落雷', '周囲の敵への落雷 +1回'], size: ['巨大星核', '星座弾サイズ +18%、ダメージ +10%'],
        orbit: ['守護衛星体', '攻撃衛星体 +1、衛星体ビルドを解放'], orbit_speed: ['超高速公転', '衛星体の回転速度 +24%'], orbit_size: ['巨大衛星核', '衛星体サイズ +20%、ダメージ +16%'], orbit_range: ['二重公転面', '公転半径 +16、衛星体ダメージ +10%'], orbit_shock: ['超新星放電', '衛星体命中時、12%の確率で範囲放電'], orbit_pulse: ['脈動星環', '全衛星体が周期的に衝撃波を放つ'], orbit_guard: ['軌道迎撃', '衛星体に触れた敵ミサイルを一定確率で消去'], orbit_intercept: ['軌道迎撃', '衛星体に触れた敵ミサイルを一定確率で消去'],
